...
public class AppConfig {
	...
	// DaoAuthenticationProvider auth=new
	// DaoAuthenticationProvider(userServiceImpl);
	// auth.setPasswordEncoder(passwordEncoder());
	// return auth;
	// }

	// @Bean
	// AuthenticationManager authManager(AuthenticationConfiguration config) throws
	// Exception {
